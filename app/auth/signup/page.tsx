        ...
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full space-y-8">
            ...
            <div className="text-center">
              ...
              <h2 className="mt-6 text-2xl font-bold text-gray-700">Create your account</h2>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="mt-1 block w-full px-4 py-3 border border-gray-300 bg-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
